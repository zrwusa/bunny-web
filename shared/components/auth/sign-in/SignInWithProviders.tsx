...
export const SignInWithProvider = memo(({
                                            className,
                                            children,
                                            onClick,
                                            provider = 'google',
    ...
    className = className || styles[`btn${toPascalCase(provider)}`];

    return <button className={className} onClick={handleSignIn} {...rest}>{children}</button>
