...
import {RightSidebarConfig, RightSidebarContext, RightSidebarEvents, RightSidebarSchema} from "./RightSidebarContext";
...
export const RightSidebarProvider = ({children}: { children: React.ReactNode }) => {
    ...
    return (
        <RightSidebarContext.Provider value={{config, setConfig, schema, setSchema, events, setEvents}}>
            {children}
