        ...
        <RightSidebarProvider>
            <main className="flex-grow flex" {...rest}>
                <Drawer isOpen={isOpen}>
                    <ul>
                        <li><Link href="/bizz-lines/inventory-supply-chain/scm/profile">profile</Link></li>
                        <li><Link href="/bizz-lines/inventory-supply-chain/scm/products">products</Link></li>
                    </ul>
                </Drawer>
